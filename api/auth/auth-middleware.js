...
const restricted = async(req, res, next) => {
    ...
    */
    try {
        const token = await req.headers.authorization; //token should be inside the header
        if (!token) {
...
const only = role_name => (req, res, next) => {
    ...
    */
    const roleName = req.decodedJwt.role_name; // should be included in the payload
